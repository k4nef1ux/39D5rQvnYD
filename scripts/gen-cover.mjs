...
const VOID = "#08080b", INK = "#ede9e1", PHOS = "#d8b47f", MUTE = "#8c877c";
...
function svg({ kind, headline, tag }) {
  ...
  ${grid}
  <text x="${PAD}" y="92" font-family="IBM Plex Mono" font-size="26" letter-spacing="4" fill="${PHOS}">findshq // ${esc(kind)}</text>
