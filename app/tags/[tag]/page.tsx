...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      meta?.description ??
      `cool finds and wholesome gifts for ${label} - hand-picked, newest first. no filler, no guesswork, just the good stuff worth giving.`,
    ...
    <div className="layout layout-index">
      ...
      <div className="layout-main">
        ...
        <p className="lede page-lede">
          {match.count} {match.count === 1 ? "post" : "posts"} tagged{" "}
