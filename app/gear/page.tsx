...
// in the yellow-tile stream beside the shared sidebar. (Route folder is a /gear
...
export const metadata: Metadata = {
  title: "all the finds",
  description: "every cool find and wholesome gift in one place - for him, for her, for them, and every occasion. hand-picked, newest first, no filler.",
    ...
    <div className="layout layout-index">
      <div className="layout-main">
        ...
        <p className="lede page-lede">
          every cool find and wholesome gift, newest first. hand-picked, never
          padded.
        </p>
        {posts.length === 0 ? (
