...
// app/error.tsx - route error boundary in the q1rk aesthetic. If a stale chunk
...
export default function Error({
  ...
  useEffect(() => {
    ...
    if (/ChunkLoadError|Loading chunk|importing a module/i.test(msg)) {
      if (!sessionStorage.getItem("q1rk-chunk-reload")) {
        sessionStorage.setItem("q1rk-chunk-reload", "1");
        window.location.reload();
      }
    } else {
      sessionStorage.removeItem("q1rk-chunk-reload");
    }
  }, [error]);
