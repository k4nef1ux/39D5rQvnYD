...
const KEY = "q1rk-consent";
// bump if the policy materially changes - forces a re-ask on next visit.
export const CONSENT_VERSION = "1";
const STORED = `${KEY}:v${CONSENT_VERSION}`;

export const CONSENT_CHANGE = "q1rk:consentchange"; // fired when the value changes
export const CONSENT_OPEN = "q1rk:consentopen"; // asks the banner to re-open
