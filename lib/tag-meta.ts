...
export const TAG_META: Record<string, TagMeta> = {
  ...
  "for-mom": { title: "gifts for mom - for the one who never asks", description: "gifts for mom that repay a few of the favors: cozy upgrades, keepsakes, the small luxuries she would never buy herself. vetted against real owner reviews." },
  "for-dad": { title: "gifts for dad - beyond the necktie default", description: "gifts for dad that skip the necktie default: leather that ages well, the tools of his rituals, upgrades he keeps not buying himself. vetted picks only." },
  "under-50": { title: "gifts under $50 - look expensive, priced kind", description: "gifts under fifty dollars that read far above their price: small luxuries, personal pieces, the finds that look chosen rather than cheap. flaws listed." },
  "for-friends": { title: "gifts for friends - chosen, not obligatory", description: "gifts for friends that say you actually know them: the cozy, the personal, the pieces that fit their place. picked to feel chosen, never last-minute." },
  "work-gifts": { title: "work gifts - coworkers, bosses, secret santa", description: "work gifts that stay professional and still feel considered: desk pieces, small upgrades, safe-but-good picks for coworkers, bosses, and secret santa." },
