...
// (the universal convention) or a "q1rk:help" event (fired by the command
...
export default function ShortcutsHelp() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("q1rk:help", onEvent);
    return () => {
      window.removeEventListener("keydown", onKey);
      window.removeEventListener("q1rk:help", onEvent);
    };
  }, []);
