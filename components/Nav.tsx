...
export default function Nav({
  ...
  useEffect(() => {
    ...
    window.addEventListener("findshq:open-menu", onOpen);
    window.addEventListener("findshq:close-menu", onClose);
    return () => {
      window.removeEventListener("findshq:open-menu", onOpen);
      window.removeEventListener("findshq:close-menu", onClose);
    };
  }, []);
